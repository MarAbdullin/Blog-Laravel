...
<div class="form-group">
    ...
    <select name="category_id" class="form-control" title="Категория">
        ...
        @include('admin.post.part.categories', ['level' => -1, 'parent' => 0])
    </select>
</div>
...
<div class="form-group">
    <input type="file" class="form-control-file" id="img" name="image" accept="image/*"> 
    <!-- для предпросмотра загружаемого изображения -->
